import { Sun, Moon, Ellipsis, SquarePlus } from 'lucide-react';
    ...
    return (
        <main className='w-full max-w-[450px] lg:max-w-[380px] xl:max-w-[450px] p-3 sm:p-4 flex flex-col items-center justify-center bg-stone-200/50 dark:bg-gray-800 rounded-lg shadow-lg transition-all duration-300'>
            ...
            <div className='flex flex-col gap-3 w-full'>
                <div className='group w-full cursor-pointer bg-white hover:scale-[1.02] active:scale-[0.98] hover:bg-stone-400/60 hover:dark:bg-blue-400/60 rounded-sm flex justify-center items-center gap-2 px-4 sm:px-5 py-3 transition-all duration-200 ease-in-out'>
